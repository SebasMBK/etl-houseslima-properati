...
def data_cleaner(raw_bucket_name:str, raw_dir:str, raw_filename:str):
    ...
    # For our purposes, Surface shouldn't be empty. This is critical information
    df.dropna(subset=['surface.total'], how='all', inplace=True)

    # For our purposes,, Bedrooms shouldn't be empty. This is critical information
    df.dropna(subset=['floor_plan.bedrooms'], how='all', inplace=True)

    # For our purposes,, Bathrooms shouldn't be empty. This is critical information
